#!/usr/bin/env python3
"""
Scrape Hamleys products from CSV file and include tags/categories
"""
...
from scrapers.hamleys_scraper import scrape_hamleys_product


def scrape_products_from_csv(csv_file, output_json='hamleys_scrape_results.json', limit=None):
    """Read CSV file and scrape Hamleys products."""
...
if __name__ == '__main__':
    csv_file = 'data/input/TLM_products_hamleys.csv'
    output_json = 'data/results/hamleys_scrape_results.json'
