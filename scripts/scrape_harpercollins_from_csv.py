#!/usr/bin/env python3
"""
Scrape HarperCollins products from CSV file and include tags/categories
"""
...
from scrapers.harpercollins_scraper import scrape_harpercollins_product


def scrape_products_from_csv(csv_file, output_json='harpercollins_scrape_results.json', limit=None):
    """Read CSV file and scrape HarperCollins products."""
...
if __name__ == '__main__':
    csv_file = 'data/input/TLM_products_harpercollins.csv'
    output_json = 'data/results/harpercollins_scrape_results.json'
